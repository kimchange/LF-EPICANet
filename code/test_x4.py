...
def parse_args():
    ...
    # parser.add_argument('--testset_dir', type=str, default='/root/user/jmc/kimchange/LFSR/LFSSR_data/TestData_2xSR_5x5/')
    parser.add_argument('--testset_dir', type=str, default='/root/user/jmc/kimchange/LFSR/LFSSR_data/TestData_4xSR_5x5/')
    ...
    # parser.add_argument('--codefolder', type=str, default='../save/checkpoint_epitrans_sandglass_0831x2/code/')
    parser.add_argument('--codefolder', type=str, default='../save/checkpoint_epitrans_sandglass_0901x4/code/')
    ...
    # parser.add_argument('--model_path', type=str, default="/root/user/jmc/kimchange/LFSR-sandglass/save/checkpoint_epitrans_sandglass_0831x2/epitrans_sandglass_2xSR_5x5_epoch_59.pth.tar")
    parser.add_argument('--model_path', type=str, default='/root/user/jmc/kimchange/LFSR-sandglass/save/checkpoint_epitrans_sandglass_0901x4/epitrans_sandglass_4xSR_5x5_epoch_74.pth.tar')
    # parser.add_argument('--save_path', type=str, default='./ValResults/')
    parser.add_argument('--save_path', type=str, default='../TestResultsx4-20230901-patch64/')
...
def test(cfg, test_Names, test_loaders):
    ...
    if os.path.isfile(cfg.model_path):
        ...
        net.eval()
        # net.load_state_dict(torch.load("/root/user/jmc/kimchange/LFSR-sandglass/save/checkpoint_epitrans_sandglass_0831x2/epitrans_sandglass_2xSR_5x5_epoch_59_state_dict.pth.tar"))

        # net.load_state_dict(torch.load('/home/slfm/as13000/kimchange/LFSR/save/checkpoint_20220326-c42conv-epixt-maxdisp2-layer6/C42net_2xSR_5x5_epoch_60_state_dict.pth.tar'))
    else:
...
def inference(test_loader, test_name, net, flag):
    ...
    for idx_iter, (data, label) in (enumerate(test_loader)):
        ...
        if cfg.crop_test_method == 4:
            ...
            if test_name not in ['HCI_old']:  # to save memory
